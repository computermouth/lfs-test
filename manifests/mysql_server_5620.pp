...
# ========================================================================
# $Id: mysql_server_5620.pp 54370 2016-06-14 17:10:05Z mchen $
# $HeadURL: http://svn.businesswire.com/svn/sysadmin/puppet/modules/hq_mysql/trunk/manifests/mysql_server_5620.pp $
# ========================================================================
class hq_mysql::mysql_server_5620 {
  #  TEST 1-  Commented out for test purpose
  require hq_packages::hq_mysql
  require hq_filesystem
  ###require hq_mysql::mysql_client_5620
