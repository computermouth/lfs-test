...
# ========================================================================
# $Id: mysql_server.pp 40652 2015-04-21 22:45:03Z jwade $
# $HeadURL: http://svn.businesswire.com/svn/sysadmin/puppet/modules/hq_mysql/trunk/manifests/mysql_server.pp $
# ========================================================================
class hq_mysql::mysql_server {
  #  TEST 1-  Commented out for test purpose
  require hq_packages::hq_mysql
  require hq_filesystem
  ###require hq_mysql::mysql_client
