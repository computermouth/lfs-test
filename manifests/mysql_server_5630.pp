...
# ========================================================================
# $Id: mysql_server_5630.pp 54358 2016-06-10 22:13:32Z mchen $
# $HeadURL: http://svn.businesswire.com/svn/sysadmin/puppet/modules/hq_mysql/tags/2.5.1.1/manifests/mysql_server_5630.pp $
# ========================================================================
class hq_mysql::mysql_server_5630 {
  #  TEST 1-  Commented out for test purpose
  require hq_packages::hq_mysql
  require hq_filesystem
  ###require hq_mysql::mysql_client_5630
  ...
  if $::bw_lifecycle != '' {
    case $::bw_lifecycle{
      ...
      'test': {$cycle=03}
      'prod': {$cycle=04}
      default: {fail "Unrecognized bw_lifecycle: ${::bw_location}"}
    }
  }
  else {
